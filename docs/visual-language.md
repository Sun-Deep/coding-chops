...
Blue is the only recurring semantic accent. Explain overload, selection, focus, and data movement through density, scale, contrast, and timing before adding another color.
